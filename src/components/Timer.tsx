...
export default function Timer({ initialMinutes }: TimerProps) {
  ...
  return (
    <div className="flex items-center gap-4 font-pt-root-ui text-3xl font-bold text-[#2D3242]">
      <span className="font-pt-root-ui text-[16px] text-[#2D3242] md:text-3xl">
        Скидка действует:
      </span>
      <div className="flex">
        <div className="flex flex-col items-center">
          ...
          <span className="-mt-2 font-pt-root-ui text-sm text-[#6D7585] md:text-lg">
            минут
          </span>
        </div>

        <div
          className={`mx-3 flex h-[61px] items-start pt-[8px] md:pt-[17px] ${
        ...
        >
          ...
          >
            <circle
              ...
              style={{
                fill: `var(--${isWarning ? 'alert-color' : 'accent-color'})`,
              }}
            />
            <circle
              cx="4"
